...
Explorrre is an interactive web application that allows users to explore countries around the world through a clean and modern interface.
...
- This project focuses on building a clean and interactive UI for data exploration  
- Can be extended with features like favorites, pagination, or region-based filtering  